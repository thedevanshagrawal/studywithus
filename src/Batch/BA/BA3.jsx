  ...
  return (
    <>
      <div className="sections">
        <Cards title="Sem 1" userLinks="/ba3/Ba3Sem1" cardImagelink={ba} />
        <Cards title="Sem 2" userLinks="/ba3/Ba3Sem2" cardImagelink={ba} />
      </div>
    </>
  );
}

export function Ba3Sem1() {
  return (
    <Notes
      note1="Upcoming"
