...
export function Bba2() {
  return (
    <>
      <div className="sections">
        <Cards title="Sem 1" userLinks="/bba2/Bba2Sem1" cardImagelink={bba} />
        <Cards title="Sem 2" userLinks="/bba2/Bba2Sem2" cardImagelink={bba} />
      </div>
    </>
  );
}

export function Bba2Sem1() {
  return (
    <Notes
      note1="Upcoming"
