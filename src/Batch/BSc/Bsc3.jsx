...
export function Bsc3() {
  return (
    <>
      <div className="sections">
        <Cards title="Sem 1" userLinks="/bsc3/Bsc3Sem1" cardImagelink={bsc} />
        <Cards title="Sem 2" userLinks="/bsc3/Bsc3Sem2" cardImagelink={bsc} />
      </div>
    </>
  );
}

export function Bsc3Sem1() {
  return (
    <Notes
      note1="Upcoming"
      ...
      // note2="OOOPs"
      // url2="https://drive.google.com/drive/folders/1j_fM8_rVDwCg0nYhoIp7Eoe6TMnOedWz?usp=drive_link"
      // note3="OOOPs"
